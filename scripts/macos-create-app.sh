...
plutil -replace CFBundleName -string "Echo" "$CONTENTS_DIR/Info.plist"
plutil -replace CFBundleDisplayName -string "Echo" "$CONTENTS_DIR/Info.plist"
plutil -replace CFBundleIdentifier -string "com.echo.voice.desktop" "$CONTENTS_DIR/Info.plist"
...
echo "Bundle id: com.echo.voice.desktop"
echo "Open it with:"
