# mobile-transcript-file-navigation Specification

## Purpose
TBD - created by archiving change open-transcript-file-links-in-workspace-browser. Update Purpose after archive.
## Requirements
